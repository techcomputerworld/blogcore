...
namespace BlogCore.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                //en vez de utilizar el de IdentityUser usamos nuestro ApplicationUser para tener acceso a las
                //propiedades que hemos puesto en ApplicationUser
                //EmailConfirmed es para que se autologuee una vez se haya confirmado el registro.
                ...
                if (result.Succeeded)
                {
                    ...
                    // si no existe ese rol Admin vamos a crearlo
                    ...
                    _logger.LogInformation("Usuario creado con éxito con contraseña ");
